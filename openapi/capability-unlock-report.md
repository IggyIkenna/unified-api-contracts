...
Manifest commit: `6186be5a550947d52461b686e024512de796cee1`

## Summary (3)

- blocked edges total: **863**
- roadmap edges (have an unlock set): **378**
- structurally-impossible edges (excluded from ranking): **485**
...
18. `ARBITRAGE_PRICE_DISPERSION` --supports--> `venue:cboe` — status `partial`, unlock_distance **1**, missing `needs-registry-entry`, demand 0
