# Strategy Prospectus: Arbitrage Mev Sandwich

> **Archetype ID**: `ARBITRAGE_MEV_SANDWICH`  
> **Family**: `ARBITRAGE_STRUCTURAL`  
> **Status** (codex): theoretical-only  
...
**[CODEX-DERIVED]** Venue universe (from doc frontmatter): BALANCER, CURVE, SUSHISWAP, UNISWAP_V3
