# Strategy Prospectus: Defi Lp Pool

> **Archetype ID**: `DEFI_LP_POOL`  
...
**[MACHINE-DERIVED]** Family: `MARKET_MAKING` | Primary venue categories: DEFI
...
> `LP_WITHDRAW` actions — those enum values do not exist; correc
> _...truncated (1304 chars total). See codex archetype doc for full detail._

## 2. Universe & Execution

**[CODEX-DERIVED]** Venue universe (from doc frontmatter): BALANCER_V2, BALANCER_V3, CURVE
