# Strategy Prospectus: Arbitrage Cross Domain Event

> **Archetype ID**: `ARBITRAGE_CROSS_DOMAIN_EVENT`  
...
**[CODEX-DERIVED]** Venue universe (from doc frontmatter): CME, KALSHI, PINNACLE, POLYMARKET, PREDICTIT
