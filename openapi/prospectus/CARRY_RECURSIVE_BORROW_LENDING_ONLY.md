...
| ----------------- | -------- | -------- | ---------------- | -------------------------------------------- |
| `loop_borrow`     | `borrow` | true     | `lending`        | `aave_v3`, `compound_v3`, `kamino`, `morpho` |
| `loop_collateral` | `lend`   | true     | `lending`        | `aave_v3`, `compound_v3`, `kamino`, `morpho` |

**Conditional leg constraints:**

| Leg               | Constraint (kind / params / fallback)                              | Condition                                            |
| ----------------- | ------------------------------------------------------------------ | ---------------------------------------------------- |
| `loop_borrow`     | `leg_constraint:requires_atomic_bundle · bundle_id=recursive_loop` | Lending-loop iterations execute atomically on-chain. |
| `loop_collateral` | `leg_constraint:requires_atomic_bundle · bundle_id=recursive_loop` | Lending-loop iterations execute atomically on-chain. |
