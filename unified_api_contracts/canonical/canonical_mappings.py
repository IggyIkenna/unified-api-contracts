...
VENUE_TO_DATA_SOURCE: dict[str, str] = {
    ...
    "UNISWAP_V3-ETHEREUM": "thegraph",
    "UNISWAP_V4-ETHEREUM": "thegraph",
    "AAVE_V3-ETHEREUM": "thegraph",
    "CURVE-ETHEREUM": "rpc",
...
DEFI_DATASET_TO_CANONICAL_VENUE: dict[str, str] = {
    "uniswap-v2-ethereum": "UNISWAP_V2-ETHEREUM",
    "uniswap-v3-ethereum": "UNISWAP_V3-ETHEREUM",
    "uniswap-v4-ethereum": "UNISWAP_V4-ETHEREUM",
    "uniswap/uniswap-v2": "UNISWAP_V2-ETHEREUM",
    "uniswap/uniswap-v3": "UNISWAP_V3-ETHEREUM",
    "curve-ethereum": "CURVE-ETHEREUM",
    "curvefi/curve-ethereum": "CURVE-ETHEREUM",
    "aerodrome-base": "AERODROME-BASE",
    "aave-v3-ethereum": "AAVE_V3-ETHEREUM",
    "aave-v3": "AAVE_V3",
