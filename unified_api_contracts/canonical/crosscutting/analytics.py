...
# ---------------------------------------------------------------------------
# Factor and correlation analytics
# ---------------------------------------------------------------------------


class FactorType(StrEnum):
    """Factor types for attribution analysis."""
...
class FactorAttributionRecord(BaseModel):
    """Attribution of PnL to a single factor for a period."""

    factor: FactorType
    return_attributed: float
    weight: float
...
class FactorAttributionModel(BaseModel):
    """Complete factor attribution model output."""
...
class CrossAssetCorrelationMatrix(BaseModel):
    """Cross-asset correlation matrix snapshot."""
