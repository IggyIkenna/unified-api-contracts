...
VENUE_ERRORS_DEFI: dict[str, list[VenueErrorClassification]] = {
    ...
    "hyperliquid": [
        ve(
            ...
            reconnect=False,
            action=ErrorAction.FAIL,
            desc="HL place_order rejected for insufficient USDC margin",
        ),
        ve(
            "hyperliquid",
            ...
            reconnect=False,
            action=ErrorAction.FAIL,
            desc="reduce_only=True on a size-increasing order",
        ),
        ve(
            "hyperliquid",
            ...
            reconnect=False,
            action=ErrorAction.FAIL,
            desc="TimeInForce mismatch — HL accepts Alo/Ioc/Gtc only",
        ),
        ve(
            "hyperliquid",
            ...
            reconnect=False,
            action=ErrorAction.RETRY,
            desc="429 or 1-req/s breach — retry with exponential backoff",
        ),
        ve(
            "hyperliquid",
            ...
            reconnect=False,
            action=ErrorAction.RETRY,
            desc="EIP-712 nonce race — re-read latest nonce from /info",
        ),
        ve(
            "hyperliquid",
            ...
            reconnect=False,
            action=ErrorAction.FAIL,
            desc="Wallet config or chainId drift — do NOT retry; alert operator",
        ),
        ve(
            "hyperliquid",
            ...
            reconnect=False,
            action=ErrorAction.SKIP,
            desc="Auto-liquidation race — cancel/modify against ghost position",
        ),
        ve(
            "hyperliquid",
            ...
            reconnect=False,
            action=ErrorAction.RETRY,
            desc="WS fill arrived >timeout — re-query /info userFills before declaring lost",
        ),
        ve(
            "hyperliquid",
            "429",
        ...
        ve(
            ...
            reconnect=False,
            action=ErrorAction.FAIL,
            desc="Unauthorized — invalid signature or wallet address",
        ),
        ve(
            "hyperliquid",
            "500",
