...
#   distinct writer bug.
# - "exchange_odds" / "fixed_odds": RETIRED 2026-08-08 (sports_taxonomy_p1_
#   capture_and_contracts_2026_08_08.md) — exchange-vs-sportsbook is a VENUE
#   property (SportsVenueType already encodes it); per-instrument stamping was
#   redundant. The lookup_contract step-5 fallback (contracts.py) still routes
#   these tokens to the "odds" contract during the P2 migration window.
# - "odds" (lowercase): the sole canonical instrument_type for sports bets.
