...
#   odds venues (exchange-vs-sportsbook is a property of the venue, not the
#   instrument_type — derive via `SportsVenueType` at read time).
# All are real `data_type=trades`/bundle-grain MTDS/MDPS output, never
