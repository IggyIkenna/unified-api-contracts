...
#   distinct writer bug.
# - "exchange_odds" / "fixed_odds": RETIRED 2026-08-08
#   (sports_taxonomy_p1_capture_and_contracts_2026_08_08.md). The 2026-07-27
#   venue-class split is reversed — venue class is derivable from
#   SportsVenueType, so per-instrument stamping is redundant. These values
#   still appear in existing GCS/manifest rows until the P2 migration moves
#   them to the canonical "odds" partition; kept here to accept live data.
# - "odds" (lowercase, generic): the sole canonical instrument_type for all
#   sports odds (both exchange and sportsbook).
