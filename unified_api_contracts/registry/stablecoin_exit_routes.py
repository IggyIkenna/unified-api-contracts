...
STABLECOIN_EMERGENCY_EXIT_ROUTES: Final[dict[str, tuple[ExitRoute, ...]]] = {
    ...
    "USDC": (
        ...
        _route(
            ...
            target="ETH",
            venue="CURVE",
            pool_address="0xbEbc44782C7dB0a1A60Cb6fe97d0b483032FF1C7",  # Curve 3pool
            typical_exit_size_usd="500000",
            slippage_bps="10",
            gas_usd="15",
            priority_rank=2,
        ...
        _route(
            ...
            target="WBTC",
            venue="UNISWAP_V3",
            pool_address="0x99ac8cA7087fA4A2A1FB6357269965A2014ABc35",  # USDC/WBTC 0.3%
            typical_exit_size_usd="500000",
            slippage_bps="12",
            gas_usd="12",
            priority_rank=5,
    ...
    "USDT": (
        _route(
            ...
            target="ETH",
            venue="UNISWAP_V3",
            pool_address="0x4e68Ccd3E89f51C3074ca5072bbAC773960dFa36",  # USDT/ETH 0.3%
            typical_exit_size_usd="500000",
            slippage_bps="9",
            gas_usd="12",
            priority_rank=1,
    ...
    "DAI": (
        _route(
            ...
            target="ETH",
            venue="UNISWAP_V3",
            pool_address="0x60594a405d53811d3BC4766596EFD80fd545A270",  # DAI/ETH 0.05%
            typical_exit_size_usd="500000",
            slippage_bps="7",
            gas_usd="12",
            priority_rank=1,
        ...
        _route(
            ...
            target="WBTC",
            venue="UNISWAP_V3",
            pool_address="0x391E8501b626C623d39474AfcA6f9e46c2686649",  # DAI/WBTC 0.3%
            typical_exit_size_usd="200000",
            slippage_bps="15",
            gas_usd="12",
            priority_rank=4,
    ...
    "USDE": (
        _route(
            ...
            target="ETH",
            venue="CURVE",
            pool_address="0x5426178799ee0a0181A89b4f57eFddfAb49941Ec",  # USDe/USDC Curve
        ...
        _route(
            ...
            target="ETH",
            venue="PENDLE",
            pool_address="0x6fcf753f2C67b83f7B09746Bbc4FA0047b35D050",
            typical_exit_size_usd="200000",
            slippage_bps="20",
            gas_usd="18",
            priority_rank=2,
        ...
        _route(
            ...
            target="USDC",
            venue="CURVE",
            pool_address="0x5426178799ee0a0181A89b4f57eFddfAb49941Ec",
            typical_exit_size_usd="300000",
            slippage_bps="12",
            gas_usd="15",
            priority_rank=3,
    ...
    "FRAX": (
        _route(
            ...
            target="ETH",
            venue="UNISWAP_V3",
            pool_address="0x92c7b5ce4CB0E5483F3365C1449f21578eE9f21A",  # FRAX/ETH 0.3%
            typical_exit_size_usd="200000",
            slippage_bps="18",
            gas_usd="12",
            priority_rank=1,
        ...
        _route(
            ...
            target="ETH",
            venue="CURVE",
            pool_address="0xd632f22692FaC7611d2AA1C0D552930D43CAEd3B",  # Frax/3Crv
            typical_exit_size_usd="200000",
            slippage_bps="20",
            gas_usd="15",
            priority_rank=2,
    ...
    "GHO": (
        _route(
            ...
            target="ETH",
            venue="UNISWAP_V3",
            pool_address="0x7b925e617AEeDf3B435a1B4a9EE0Cc4b3c0B834D",  # GHO/ETH 0.3%
        ...
        _route(
            ...
            target="USDC",
            venue="UNISWAP_V3",
            pool_address="0x7b925e617AEeDf3B435a1B4a9EE0Cc4b3c0B834D",
            typical_exit_size_usd="100000",
            slippage_bps="20",
            gas_usd="12",
            priority_rank=2,
        ...
        _route(
            ...
            target="ETH",
            venue="CURVE",
            pool_address="0x8353157092ED8Be69a9Df8F95af097bbF33Cb2aF",  # GHO/USDC/USDT Curve
            typical_exit_size_usd="100000",
            slippage_bps="28",
            gas_usd="15",
            priority_rank=3,
    ...
    "CRVUSD": (
        _route(
            ...
            target="ETH",
            venue="CURVE",
            pool_address="0x4DEcE678ceceb27446b35C672dC7d61F30bAD69E",  # crvUSD/USDC
            typical_exit_size_usd="200000",
            slippage_bps="15",
            gas_usd="15",
            priority_rank=1,
    ...
    "PYUSD": (
        _route(
            ...
            target="ETH",
            venue="CURVE",
            pool_address="0x383E6b4437b59fff47B619CBA855CA29342A8559",  # PYUSD/USDC Curve
            typical_exit_size_usd="100000",
            slippage_bps="20",
            gas_usd="15",
            priority_rank=1,
    ...
    "SUSDE": (
        ...
        _route(
            ...
            target="ETH",
            venue="CURVE",
            pool_address="0x167478921b907422F8E88B43C4Af2B8BEa278d3A",  # sUSDe/USDC Curve
            typical_exit_size_usd="200000",
            slippage_bps="18",
            gas_usd="15",
            priority_rank=2,
        ...
        _route(
            ...
            target="ETH",
            venue="UNISWAP_V3",
            pool_address="0x167478921b907422F8E88B43C4Af2B8BEa278d3A",
            typical_exit_size_usd="200000",
            slippage_bps="22",
            gas_usd="12",
            priority_rank=3,
    ...
    "BUSD": (
        ...
        _route(
            ...
            target="USDC",
            venue="CURVE",
            pool_address="0x4fabb145d64652a948d72533023f6e7a623c7c53",  # BUSD/USDC
            typical_exit_size_usd="100000",
            slippage_bps="12",
            gas_usd="15",
            priority_rank=2,
