...
UNIBET = "UNIBET"
UNIBET_EU = "UNIBET_EU"  # Unibet EU regional feed — distinct bookmaker feed from UNIBET (content-verified 2026-07-27)
UNIBET_UK = "UNIBET_UK"  # Unibet UK regional feed — distinct bookmaker feed from UNIBET (content-verified 2026-07-27)
BETFRED = "BETFRED"
CASUMO = "CASUMO"
GROSVENOR = "GROSVENOR"
LEOVEGAS = "LEOVEGAS"
