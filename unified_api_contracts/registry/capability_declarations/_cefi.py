...
# Pacifica (Solana on-chain CeFi perp CLOB) SourceCapability removed 2026-07-16
# (operator ruling: all Solana perp DEXes dropped except Jupiter, not
# integrated — Drift was hacked 2026-04-01, rebranded to Velocity DEX, now a
# ~2-week-old private beta with ~$0 listed TVL; Pacifica dropped under the
# same "kill all Solana perp DEXes" ruling). SSOT: unified-trading-pm/codex/
