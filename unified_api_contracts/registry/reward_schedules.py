...
REWARD_SCHEDULES: list[RewardScheduleEntry] = [
    RewardScheduleEntry(
        protocol="EIGENLAYER",
        reward_token="EIGEN",
        reward_token_address="0xec53bF9167f50cDEB3Ae105f56099aaaB9061F83",  # DERIVED ethereum etherscan
        frequency="WEEKLY",
    ...
    RewardScheduleEntry(
        protocol="ETHERFI",
        reward_token="ETHFI",
        reward_token_address="0xFe0c30065B384F05761f15d0CC899D4F9F9Cc0eB",  # DERIVED ethereum etherscan
        frequency="QUARTERLY",
