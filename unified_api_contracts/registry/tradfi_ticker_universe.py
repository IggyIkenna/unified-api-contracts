...
:data:`SP500_TICKERS` lives in ``_tradfi_sp500_tickers.py`` (900-line file-size
QG split, 2026-07-09; pure file-organization move, no behavior change) and is
re-exported here — this module stays the import surface.
"""

from __future__ import annotations

from unified_api_contracts.registry._tradfi_sp500_tickers import SP500_TICKERS
