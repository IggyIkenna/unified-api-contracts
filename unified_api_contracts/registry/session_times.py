...
_EXCHANGE_SESSIONS: dict[str, SessionWindow] = {
    ...
    "COINBASE": _CRYPTO_SESSION,
    "HYPERLIQUID": _CRYPTO_SESSION,
    "ASTER": _CRYPTO_SESSION,
    # DeFi — all 24/7
    "AAVEV3-ETHEREUM": _CRYPTO_SESSION,
    "UNISWAPV2-ETHEREUM": _CRYPTO_SESSION,
    "UNISWAPV3-ETHEREUM": _CRYPTO_SESSION,
    "UNISWAPV4-ETHEREUM": _CRYPTO_SESSION,
