...
_UPBIT = SourceCapability(
    ...
    auth_environments={"prod": "prod_key"},
    operations={
        "market": ["ticker", "orderbook", "trades", "candles_minutes", "candles_days", "ws_ticker", "ws_orderbook", "ws_trade"],
...
_CCXT = SourceCapability(
    ...
    auth_environments={"test": "testnet_key", "prod": "prod_key"},
    operations={
        "market": ["fetch_ticker", "fetch_order_book", "fetch_trades", "fetch_ohlcv", "watch_ticker", "watch_order_book"],
...
_ASTER = SourceCapability(
    ...
    auth_environments={"test": "testnet_key", "prod": "prod_key"},
    operations={
        "market": ["ticker", "orderbook", "trades", "ohlcv", "liquidations", "derivative_ticker", "ws_ticker", "ws_depth", "ws_trades"],
