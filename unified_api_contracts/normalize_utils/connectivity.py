...
NOTE: This module MUST NOT import from external/{venue}/normalize.py because
several of those modules (aster, ibkr, upbit) import normalize_ws_disconnect
from this module, creating a circular dependency.  All venue-specific WS
lifecycle functions are kept inline here — they are thin wrappers that do not
require raw venue schemas.
"""
