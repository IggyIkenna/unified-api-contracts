...
Kept in external/ (same rationale as external/defi/ and external/prime_broker/)
because these schemas mirror upstream protocol interfaces, not our canonical domain.
