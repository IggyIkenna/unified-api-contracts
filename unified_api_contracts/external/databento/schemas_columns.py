...
DATABENTO_MBP_10_SCHEMA: list[dict[str, str | bool]] = [
    {
        "name": "ts_recv",
        "type": "int64",
        "required": True,
        "description": "Capture-server received timestamp (nanoseconds)",
    },
    {
        "name": "ts_event",
        "type": "int64",
        "required": True,
        "description": "Matching-engine received timestamp (nanoseconds)",
    },
    {"name": "rtype", "type": "int8", "required": True, "description": "Record type sentinel"},
    {"name": "publisher_id", "type": "int16", "required": True, "description": "Publisher ID"},
    {"name": "instrument_id", "type": "int32", "required": True, "description": "Instrument ID"},
    {
        "name": "action",
        "type": "string",
        "required": True,
        "description": "Event action: A=Add, C=Cancel, M=Modify, R=Clear, T=Trade",
    },
    {"name": "side", "type": "string", "required": True, "description": "Initiating side: A, B, N"},
    {"name": "depth", "type": "int8", "required": True, "description": "Book level of the update"},
    {"name": "price", "type": "int64", "required": True, "description": "Order price (fixed-point, divide by 1e9)"},
    {"name": "size", "type": "int32", "required": True, "description": "Order quantity"},
    {"name": "flags", "type": "int8", "required": False, "description": "Bit field for event/quality flags"},
    {"name": "ts_in_delta", "type": "int32", "required": False, "description": "Timestamp delta in nanoseconds"},
    {"name": "sequence", "type": "int32", "required": False, "description": "Sequence number"},
    {"name": "bid_px_00", "type": "int64", "required": True, "description": "Bid price level 0 (fixed-point)"},
    {"name": "ask_px_00", "type": "int64", "required": True, "description": "Ask price level 0 (fixed-point)"},
    {"name": "bid_sz_00", "type": "int32", "required": True, "description": "Bid size level 0"},
    {"name": "ask_sz_00", "type": "int32", "required": True, "description": "Ask size level 0"},
    {"name": "bid_ct_00", "type": "int32", "required": False, "description": "Bid order count level 0"},
    {"name": "ask_ct_00", "type": "int32", "required": False, "description": "Ask order count level 0"},
    {"name": "bid_px_01", "type": "int64", "required": False, "description": "Bid price level 1"},
    {"name": "ask_px_01", "type": "int64", "required": False, "description": "Ask price level 1"},
    {"name": "bid_sz_01", "type": "int32", "required": False, "description": "Bid size level 1"},
    {"name": "ask_sz_01", "type": "int32", "required": False, "description": "Ask size level 1"},
    {"name": "bid_ct_01", "type": "int32", "required": False, "description": "Bid order count level 1"},
    {"name": "ask_ct_01", "type": "int32", "required": False, "description": "Ask order count level 1"},
    {"name": "bid_px_02", "type": "int64", "required": False, "description": "Bid price level 2"},
    {"name": "ask_px_02", "type": "int64", "required": False, "description": "Ask price level 2"},
    {"name": "bid_sz_02", "type": "int32", "required": False, "description": "Bid size level 2"},
    {"name": "ask_sz_02", "type": "int32", "required": False, "description": "Ask size level 2"},
    {"name": "bid_ct_02", "type": "int32", "required": False, "description": "Bid order count level 2"},
    {"name": "ask_ct_02", "type": "int32", "required": False, "description": "Ask order count level 2"},
    {"name": "bid_px_03", "type": "int64", "required": False, "description": "Bid price level 3"},
    {"name": "ask_px_03", "type": "int64", "required": False, "description": "Ask price level 3"},
    {"name": "bid_sz_03", "type": "int32", "required": False, "description": "Bid size level 3"},
    {"name": "ask_sz_03", "type": "int32", "required": False, "description": "Ask size level 3"},
    {"name": "bid_ct_03", "type": "int32", "required": False, "description": "Bid order count level 3"},
    {"name": "ask_ct_03", "type": "int32", "required": False, "description": "Ask order count level 3"},
    {"name": "bid_px_04", "type": "int64", "required": False, "description": "Bid price level 4"},
    {"name": "ask_px_04", "type": "int64", "required": False, "description": "Ask price level 4"},
    {"name": "bid_sz_04", "type": "int32", "required": False, "description": "Bid size level 4"},
    {"name": "ask_sz_04", "type": "int32", "required": False, "description": "Ask size level 4"},
    {"name": "bid_ct_04", "type": "int32", "required": False, "description": "Bid order count level 4"},
    {"name": "ask_ct_04", "type": "int32", "required": False, "description": "Ask order count level 4"},
    {"name": "bid_px_05", "type": "int64", "required": False, "description": "Bid price level 5"},
    {"name": "ask_px_05", "type": "int64", "required": False, "description": "Ask price level 5"},
    {"name": "bid_sz_05", "type": "int32", "required": False, "description": "Bid size level 5"},
    {"name": "ask_sz_05", "type": "int32", "required": False, "description": "Ask size level 5"},
    {"name": "bid_ct_05", "type": "int32", "required": False, "description": "Bid order count level 5"},
    {"name": "ask_ct_05", "type": "int32", "required": False, "description": "Ask order count level 5"},
    {"name": "bid_px_06", "type": "int64", "required": False, "description": "Bid price level 6"},
    {"name": "ask_px_06", "type": "int64", "required": False, "description": "Ask price level 6"},
    {"name": "bid_sz_06", "type": "int32", "required": False, "description": "Bid size level 6"},
    {"name": "ask_sz_06", "type": "int32", "required": False, "description": "Ask size level 6"},
    {"name": "bid_ct_06", "type": "int32", "required": False, "description": "Bid order count level 6"},
    {"name": "ask_ct_06", "type": "int32", "required": False, "description": "Ask order count level 6"},
    {"name": "bid_px_07", "type": "int64", "required": False, "description": "Bid price level 7"},
    {"name": "ask_px_07", "type": "int64", "required": False, "description": "Ask price level 7"},
    {"name": "bid_sz_07", "type": "int32", "required": False, "description": "Bid size level 7"},
    {"name": "ask_sz_07", "type": "int32", "required": False, "description": "Ask size level 7"},
    {"name": "bid_ct_07", "type": "int32", "required": False, "description": "Bid order count level 7"},
    {"name": "ask_ct_07", "type": "int32", "required": False, "description": "Ask order count level 7"},
    {"name": "bid_px_08", "type": "int64", "required": False, "description": "Bid price level 8"},
    {"name": "ask_px_08", "type": "int64", "required": False, "description": "Ask price level 8"},
    {"name": "bid_sz_08", "type": "int32", "required": False, "description": "Bid size level 8"},
    {"name": "ask_sz_08", "type": "int32", "required": False, "description": "Ask size level 8"},
    {"name": "bid_ct_08", "type": "int32", "required": False, "description": "Bid order count level 8"},
    {"name": "ask_ct_08", "type": "int32", "required": False, "description": "Ask order count level 8"},
    {"name": "bid_px_09", "type": "int64", "required": False, "description": "Bid price level 9"},
    {"name": "ask_px_09", "type": "int64", "required": False, "description": "Ask price level 9"},
    {"name": "bid_sz_09", "type": "int32", "required": False, "description": "Bid size level 9"},
    {"name": "ask_sz_09", "type": "int32", "required": False, "description": "Ask size level 9"},
    {"name": "bid_ct_09", "type": "int32", "required": False, "description": "Bid order count level 9"},
    {"name": "ask_ct_09", "type": "int32", "required": False, "description": "Ask order count level 9"},
]
...
DATABENTO_SCHEMA_MAP: dict[str, list[dict[str, str | bool]]] = {
    ...
    "mbp_10": DATABENTO_MBP_10_SCHEMA,
