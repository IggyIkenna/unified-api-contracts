...
Includes both canonical schemas (FootyStats*) and raw API response schemas (FT*Raw).
Raw schemas mirror the FootyStats API JSON structure with all fields optional except IDs.
"""
