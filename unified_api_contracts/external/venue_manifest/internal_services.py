...
INTERNAL_CONTRACTS: dict[str, ContractEntry] = {
    "fix": {
        "module": "unified_api_contracts.external.fix.schemas",
        "description": (
    ...
    "risk_analytics": {
        "module": "unified_api_contracts.canonical.domain.risk",
        "description": (
    ...
    "latency": {
        "module": "unified_api_contracts.canonical.domain.latency",
        "description": (
    ...
    "analytics": {
        "module": "unified_api_contracts.canonical.domain.analytics",
        "description": (
    ...
    "cloud_sdks": {
        "module": "unified_api_contracts.external.cloud_sdks",
        "has_rest": False,
        "has_websocket": False,
        "has_fix": False,
        "config_secret_field": "",
