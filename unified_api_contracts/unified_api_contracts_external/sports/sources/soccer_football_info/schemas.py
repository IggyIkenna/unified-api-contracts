...
Contains two schema layers:
- SFI* models: clean, normalised schemas for the unified pipeline.
- SF*Raw models: raw schemas mirroring the legacy SQLAlchemy SF* tables from
  sports-betting-services-previous, used for ingestion before transformation.
"""
