...
Prime brokers provide credit intermediation, cross-venue netting, and settlement
services. These schemas cover account state, netting instructions, margin calls,
and cleared fills.
"""
