...
from unified_api_contracts.schemas.protocol_sdks import (
    AaveV3ReserveData,
...
AAVE_ORACLE_PRICES_SCHEMA: list[dict[str, str | bool]] = [
    ...
    {"name": "priceInEth", "type": "float64", "required": True, "description": "Price denominated in ETH"},
    {"name": "priceInUsd", "type": "float64", "required": False, "description": "Price denominated in USD"},
]
...
UNISWAP_SWAPS_SCHEMA: list[dict[str, str | bool]] = [
    ...
    {"name": "timestamp", "type": "int64", "required": True, "description": "Swap timestamp (Unix seconds)"},
...
UNISWAP_POOL_HOUR_DATA_SCHEMA: list[dict[str, str | bool]] = [
    ...
    {"name": "token0Price", "type": "float64", "required": True, "description": "Price of token0 in terms of token1"},
    {"name": "token1Price", "type": "float64", "required": True, "description": "Price of token1 in terms of token0"},
    {"name": "tick", "type": "int64", "required": False, "description": "Current tick"},
    {"name": "tvlUSD", "type": "float64", "required": False, "description": "Total value locked in USD"},
    {"name": "volumeUSD", "type": "float64", "required": False, "description": "Volume in USD for the hour"},
    {"name": "feesUSD", "type": "float64", "required": False, "description": "Fees collected in USD for the hour"},
    {"name": "open", "type": "float64", "required": False, "description": "Opening price (token0 in token1)"},
...
LST_ORACLE_PRICES_SCHEMA: list[dict[str, str | bool]] = [
    {"name": "timestamp", "type": "datetime", "required": True, "description": "Data timestamp (UTC)"},
    {"name": "token", "type": "string", "required": True, "description": "LST token symbol (wstETH, weETH)"},
    {"name": "priceInEth", "type": "float64", "required": True, "description": "Exchange rate to ETH"},
    {"name": "priceInUsd", "type": "float64", "required": False, "description": "Price in USD (if available)"},
]
...
ASTER_TRADES_SCHEMA: list[dict[str, str | bool]] = [
    {"name": "timestamp", "type": "int64", "required": True, "description": "Trade timestamp (Unix milliseconds)"},
...
ASTER_OPEN_INTEREST_SCHEMA: list[dict[str, str | bool]] = [
    {"name": "timestamp", "type": "int64", "required": True, "description": "Data timestamp (Unix milliseconds)"},
    {"name": "symbol", "type": "string", "required": True, "description": "Trading pair symbol"},
    {"name": "openInterest", "type": "float64", "required": True, "description": "Open interest in base currency"},
    {"name": "openInterestValue", "type": "float64", "required": False, "description": "Open interest value in USD"},
]
...
YAHOO_OHLCV_24H_SCHEMA: list[dict[str, str | bool]] = [
    ...
    {"name": "Adj Close", "type": "float64", "required": False, "description": "Adjusted closing price (for equities)"},
