...
NOTE: Default venue="BINANCE" is the NautilusTrader internal name (bare).
For UTS canonical names, use "BINANCE-SPOT" or "BINANCE-FUTURES" at the adapter boundary.
