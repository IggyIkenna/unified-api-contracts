...
from ...unified_api_contracts_external.aster.schemas import (
    AsterFundingRate,
    AsterMarkPrice,
    AsterOpenInterest,
)
...
from ...unified_api_contracts_external.ccxt.schemas import CcxtFundingRate
from ...unified_api_contracts_external.deribit.schemas import DeribitTickerFull
...
from ..domain import CanonicalDerivativeTicker
