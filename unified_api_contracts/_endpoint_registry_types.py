"""Endpoint registry type definitions — shared between endpoint_registry and _endpoint_registry_data.

Separated to avoid a circular import: endpoint_registry.py would otherwise depend on
_endpoint_registry_data.py, which in turn imports EndpointSpec from endpoint_registry.py.
"""
