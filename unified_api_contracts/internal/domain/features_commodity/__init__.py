...
COMMODITY_FEATURES_SCHEMA = SchemaDefinition(
    ...
    version="1.0",
    description=("Commodity feature factor rows (storage, weather, COT, rig count, momentum) for NG and CL."),
    ...
    columns=[
        ...
        ColumnSchema(
            ...
            nullable=False,
            description=(
                "Factor group key: storage_alpha | weather_delta | cot_positioning | rig_count | price_momentum"
            ),
        ),
        # ======================================================================
        # FACTOR VALUE FIELDS
        ...
        ColumnSchema(
            ...
            dtype="float64",
            nullable=True,
            description=("IC-weighted composite signal in [-1.0, 1.0]. Only populated when factor_group='composite'."),
        ),
        ColumnSchema(
            name="regime",
            dtype="string",
        ...
        ColumnSchema(
            ...
            nullable=True,
            description=(
                "HMM posterior probability of current regime state [0.0, 1.0]. Only populated for composite row."
            ),
        ),
    ],
)
