...
TIME_FEATURES_SCHEMA = SchemaDefinition(
    ...
    columns=[
        ...
        # Trading sessions
        ColumnSchema(name="asia_session", dtype="int64", nullable=False, description="Asia session (0/1)"),
        ColumnSchema(name="london_session", dtype="int64", nullable=False, description="London session (0/1)"),
        ColumnSchema(name="ny_session", dtype="int64", nullable=False, description="NY session (0/1)"),
        ColumnSchema(
        ...
        # Cyclical encoding
        ColumnSchema(name="hour_sin", dtype="float64", nullable=False, description="sin(2pi * hour / 24)"),
        ColumnSchema(name="hour_cos", dtype="float64", nullable=False, description="cos(2pi * hour / 24)"),
        ColumnSchema(
            name="day_sin",
            dtype="float64",
            nullable=False,
