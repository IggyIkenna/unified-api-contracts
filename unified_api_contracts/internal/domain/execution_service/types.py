...
``unified_api_contracts.internal.domain.matching_engine`` is a separate concept
(LIMIT, IOC, FOK, etc.).
"""
...
class ExecutionInstruction:
    ...
    def from_dict(cls, data: dict[str, object]) -> ExecutionInstruction:
        ...
        return cls(
            ...
            limit_price=(Decimal(cast(str, data["limit_price"])) if data.get("limit_price") else None),
            order_type=(OrderType(cast(str, data["order_type"])) if data.get("order_type") else None),
            ...
            priority_fee_gwei=Decimal(cast(str, data["priority_fee_gwei"])) if data.get("priority_fee_gwei") else None,
