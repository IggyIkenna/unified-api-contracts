...
class EconomicResultItem(BaseModel):
    ...
    id: str = ""  # qg-empty-fallback: honest absence: field optional in this context; caller validates
    ...
    unit: str = ""  # qg-empty-fallback: honest absence: field optional in this context; caller validates
