...
INSTRUMENTS_SCHEMA = SchemaDefinition(
    ...
    columns=[
        ...
        ColumnSchema(name="strike", dtype="string", nullable=True, description="Strike price for options"),
        ColumnSchema(
            name="option_type",
            dtype="string",
            nullable=True,
        ...
        ColumnSchema(name="reserve_factor", dtype="float64", nullable=True, description="Reserve factor"),
        ColumnSchema(name="emode_category_id", dtype="int64", nullable=True, description="E-mode category ID"),
        ColumnSchema(name="emode_label", dtype="string", nullable=True, description="E-mode category label"),
        ColumnSchema(
...
SCHEMA_METADATA: dict[str, str | list[str]] = {
    ...
    "source_model": ("InstrumentDefinition (unified_api_contracts.internal.reference.instrument_definition)"),
