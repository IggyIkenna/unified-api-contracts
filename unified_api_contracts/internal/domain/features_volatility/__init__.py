...
OPTIONS_IV_SCHEMA = SchemaDefinition(
    ...
    columns=[
        ...
        # ATM features
        ColumnSchema(name="atm_iv", dtype="float64", nullable=True, description="ATM implied volatility"),
        # 25-delta features
        ColumnSchema(name="call_25d_iv", dtype="float64", nullable=True, description="25-delta call IV"),
        ColumnSchema(name="put_25d_iv", dtype="float64", nullable=True, description="25-delta put IV"),
        ColumnSchema(name="skew_25d", dtype="float64", nullable=True, description="25-delta skew"),
        ColumnSchema(name="skew_25d_ratio", dtype="float64", nullable=True, description="25-delta skew ratio"),
        ColumnSchema(
        ...
        ColumnSchema(name="butterfly_25d", dtype="float64", nullable=True, description="25-delta butterfly"),
        # Term structure
        ColumnSchema(name="term_slope", dtype="float64", nullable=True, description="IV term slope"),
        ColumnSchema(name="term_curvature", dtype="float64", nullable=True, description="IV term curvature"),
        # Moneyness features
        ColumnSchema(
        ...
        ColumnSchema(name="iv_at_100_moneyness", dtype="float64", nullable=True, description="IV at ATM"),
        ColumnSchema(
...
FUTURES_TERM_STRUCTURE_SCHEMA = SchemaDefinition(
    ...
    columns=[
        ...
        # Basis fields
        ColumnSchema(name="basis", dtype="float64", nullable=True, description="Basis (front - spot)"),
        ColumnSchema(name="basis_pct", dtype="float64", nullable=True, description="Basis percentage"),
        ColumnSchema(name="annualized_basis", dtype="float64", nullable=True, description="Annualized basis"),
        # Curve shape
        ColumnSchema(name="curve_slope", dtype="float64", nullable=True, description="Curve slope"),
        ColumnSchema(name="curve_curvature", dtype="float64", nullable=True, description="Curve curvature"),
        # Roll features
        ColumnSchema(name="roll_yield_1m", dtype="float64", nullable=True, description="1-month roll yield"),
        ColumnSchema(name="roll_yield_3m", dtype="float64", nullable=True, description="3-month roll yield"),
    ],
)
