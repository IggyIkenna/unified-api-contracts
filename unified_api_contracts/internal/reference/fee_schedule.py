...
class ClientFeeSchedule:
    ...
    def _entries_for(self, instrument_type: str | None) -> list[FeeScheduleEntry]:
        return [e for e in self.entries if e.instrument_type in (instrument_type, None) and e.is_active()]
    ...
    def layer(self, fee_type: FeeType, instrument_type: str | None = None) -> FeeScheduleEntry | None:
