...
Usage:
    from unified_api_contracts.internal.testing import SyntheticDataGenerator, ScenarioConfig
...
from unified_api_contracts.internal.testing._seed_writer import (  # noqa: F401 — facade re-exports (split 2026-06-11); import path stability
    SeedDataWriter,
...
class SyntheticDataGenerator:
    ...
    def generate_for_instruments(
        ...
        deleted_patterns = [
            o.instrument_key or o.pattern for o in overrides if o.action == InstrumentOverrideAction.DELIST
        ]
        expired_patterns = [
            o.instrument_key or o.pattern for o in overrides if o.action == InstrumentOverrideAction.EXPIRE
        ]
        ...
        for inst in instruments:
            ...
            df = self._generate_for_single_instrument(inst, start, effective_end, interval, itype, asset_class)
