...
Import directly from submodules (require optional deps: numpy, pandas, pyarrow, pyyaml):
    ...
    from unified_api_contracts.internal.testing.synthetic import SyntheticDataGenerator, SeedDataWriter
    from unified_api_contracts.internal.testing.tick_replay import TickReplayEngine, make_tick

Pytest fixtures — register in conftest.py:
    pytest_plugins = ["unified_api_contracts.internal.testing.conftest_fixtures"]
