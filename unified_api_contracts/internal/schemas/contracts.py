...
def lookup_contract(
    *,
    ...
    Resolution order (each step falls through to the next on miss):
        ...
        5. (reserved — EXCHANGE_ODDS/FIXED_ODDS dual-read window retired
           2026-08-08; exchange-vs-sportsbook is a property of the VENUE,
           derived at read time via ``SportsVenueType``, not stamped per
           instrument_type.)
