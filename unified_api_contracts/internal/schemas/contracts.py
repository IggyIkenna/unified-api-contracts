...
# RETIRED 2026-08-08 (sports_taxonomy_p1_capture_and_contracts_2026_08_08.md):
# exchange_odds/fixed_odds instrument_type split is retired — venue class is
# derivable from SportsVenueType already encoded in the venue. The explicit
# CONTRACT_REGISTRY entries for ("sports","exchange_odds"/"fixed_odds","trades")
# have been removed. This fallback remains for backward compat during the P2
# GCS migration window: existing manifest rows still carry exchange_odds/
# fixed_odds paths until P2 moves them to odds/ — any lookup against these
# instrument_types falls back to the canonical odds contract unchanged.
