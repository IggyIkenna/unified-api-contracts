...
_SOURCE_PRIORITY_EXCLUSION_REASONS: dict[tuple[str, str], str] = {
    ...
    # MTDS L2 microstructure (depth_of_book_10 / queue_position) — derived from
    # book_snapshot_5, not produced by any raw market-data instrument_type
    # (computed-service output, like greeks_snapshot). order_flow_imbalance, the
