...
def test_classifier_legacy_14_buckets(
    ...
    category, underlying, _, _ = classify_polymarket_market(
        title="", slug=slug, event_slug="", outcome="Up"
    )
...
@pytest.mark.parametrize(
    ...
    [
        # Politics US
        ("trump-impeached-2025", "Will Trump be impeached in 2025?", "", "Yes",
         PredictionShardCategory.POLITICS_US, "TRUMP"),
        ("kamala-pick-vp", "Who will Kamala pick as VP?", "", "Josh Shapiro",
         PredictionShardCategory.POLITICS_US, "KAMALA_HARRIS"),
        ("biden-drop-out-2024", "Will Biden drop out?", "", "Yes",
         PredictionShardCategory.POLITICS_US, "BIDEN"),
        ("desantis-wins-primary-2028", "DeSantis wins primary", "", "Yes",
         PredictionShardCategory.POLITICS_US, "DESANTIS"),
        ("us-president-2028-winner", "2028 US President", "", "Kamala Harris",
         PredictionShardCategory.POLITICS_US, "US_ELECTION"),
        ("senate-majority-2026", "Senate majority 2026", "", "Democrats",
         PredictionShardCategory.POLITICS_US, "US_SENATE"),
        # Politics International
        ("uk-election-2029", "Next UK general election winner", "", "Labour",
         PredictionShardCategory.POLITICS_INTL, "UK_ELECTION"),
        ("macron-approval-2026", "Macron approval Q2", "", "Above 40%",
         PredictionShardCategory.POLITICS_INTL, "MACRON"),
        ("india-election-2029", "India PM 2029", "", "Modi",
         PredictionShardCategory.POLITICS_INTL, "INDIA_ELECTION"),
        # Sports — football
        ("epl-winner-2026", "Premier League winner", "", "Man City",
         PredictionShardCategory.SPORTS_FOOTBALL, "EPL"),
        ("world-cup-2026-winner", "World Cup 2026", "", "Brazil",
         PredictionShardCategory.SPORTS_FOOTBALL, "WORLD_CUP"),
        ("champions-league-2026-final", "UCL 2026 winner", "", "Real Madrid",
         PredictionShardCategory.SPORTS_FOOTBALL, "CHAMPIONS_LEAGUE"),
        ("super-bowl-2027-winner", "Super Bowl LXI winner", "", "Chiefs",
         PredictionShardCategory.SPORTS_FOOTBALL, "NFL"),
        # Sports — other
        ("nba-finals-2026-mvp", "NBA Finals MVP", "", "SGA",
         PredictionShardCategory.SPORTS_OTHER, "NBA"),
        ("f1-2026-drivers-champion", "F1 Drivers Champion 2026", "", "Verstappen",
         PredictionShardCategory.SPORTS_OTHER, "F1"),
        ("wimbledon-2026-winner", "Wimbledon 2026 champion", "", "Alcaraz",
         PredictionShardCategory.SPORTS_OTHER, "TENNIS"),
        ("pga-masters-tournament-2026", "Masters 2026 winner", "", "Scheffler",
         PredictionShardCategory.SPORTS_OTHER, "GOLF"),
        ("ufc-300-main-event", "UFC 300 main event winner", "", "Poirier",
         PredictionShardCategory.SPORTS_OTHER, "UFC"),
        # Culture
        ("oscars-best-picture-2026", "Best Picture 2026", "", "Oppenheimer",
         PredictionShardCategory.CULTURE, "OSCARS"),
        ("grammys-album-of-year-2026", "Album of the Year", "", "Taylor Swift",
         PredictionShardCategory.CULTURE, "GRAMMYS"),
        ("emmys-drama-2026", "Outstanding Drama Series", "", "Succession",
         PredictionShardCategory.CULTURE, "EMMYS"),
        ("taylor-swift-tour-2026-gross", "Eras Tour gross 2026", "", "Above 1B",
         PredictionShardCategory.CULTURE, "TAYLOR_SWIFT"),
        # Tech
        ("will-nvda-announce-jan-15", "Will NVDA announce Blackwell Jan 15?", "",
         "Yes", PredictionShardCategory.TECH, "NVDA"),
        ("openai-gpt-5-release-2026", "GPT-5 release before July 2026", "", "Yes",
         PredictionShardCategory.TECH, "OPENAI"),
        ("chatgpt-5-launch-2026", "ChatGPT-5 launches Q2", "", "Yes",
         PredictionShardCategory.TECH, "OPENAI"),
        ("claude-5-release-2026", "Claude 5 release", "", "Yes",
         PredictionShardCategory.TECH, "ANTHROPIC"),
        ("tesla-deliveries-q2-2026", "Tesla Q2 deliveries above 500k", "", "Yes",
         PredictionShardCategory.TECH, "TSLA"),
        # Weather
        ("hurricane-atlantic-2026-season", "Atlantic hurricane season 2026",
         "", "Above average",
         PredictionShardCategory.WEATHER, "HURRICANE"),
        ("heat-wave-europe-2026", "Europe heat wave summer 2026", "", "Yes",
         PredictionShardCategory.WEATHER, "HEAT_WAVE"),
        ("el-nino-2026", "El Nino continues through 2026", "", "Yes",
         PredictionShardCategory.WEATHER, "EL_NINO"),
        # Macro
        ("fed-rate-cut-may-2026", "Fed cuts rates in May", "", "Yes",
         PredictionShardCategory.MACRO, "FED_FUNDS"),
        ("cpi-above-3-may-2026", "May CPI above 3%", "", "Yes",
         PredictionShardCategory.MACRO, "CPI"),
        ("nfp-above-200k-may-2026", "May NFP above 200k", "", "Yes",
         PredictionShardCategory.MACRO, "NONFARM_PAYROLLS"),
        ("unemployment-above-5-2026", "Unemployment rises above 5%", "", "Yes",
         PredictionShardCategory.MACRO, "UNEMPLOYMENT"),
        # FX
        ("usd-jpy-above-160-april", "USD/JPY above 160 end of April", "", "Yes",
         PredictionShardCategory.FX, "USDJPY"),
    ],
)
...
def test_classifier_market_type(
    slug: str, outcome: str, expected: PredictionShardMarketType
) -> None:
    _, _, market_type, _ = classify_polymarket_market(
        title="", slug=slug, event_slug="", outcome=outcome
    )
...
def test_classifier_resolution_period(
    slug: str, title: str, expected: PredictionShardResolutionPeriod
) -> None:
    _, _, _, resolution_period = classify_polymarket_market(
        title=title, slug=slug, event_slug="", outcome="Up"
    )
...
def test_classifier_returns_tuple_of_enums() -> None:
    result = classify_polymarket_market(
        title="", slug="bnb-up-or-down-april-15", event_slug="", outcome="Up"
    )
