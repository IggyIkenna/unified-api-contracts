...
class TestResolveVenueContextSportsExchange:
    """Sports exchange: BETFAIR_EX_UK (bare BETFAIR is the operator-group parent, 2026-08-08)."""
...
class TestResolveVenueContextParametrized:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("BETFAIR_EX_UK", "sports"),  # bare BETFAIR removed 2026-08-08: operator-group parent
            ("DRAFTKINGS", "sports"),
            ("KALSHI", "prediction"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("BETFAIR_EX_UK", "clob_api"),  # bare BETFAIR removed 2026-08-08: operator-group parent
        ],
    )
