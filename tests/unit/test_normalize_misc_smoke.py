...
from unified_api_contracts.unified_normalised_contracts.errors import RateLimitInfo
...
class TestSideNormalizer:
    def test_buy_variants(self):
        from unified_api_contracts.unified_normalised_contracts.normalize.sides import (
            normalize_side,
        )
...
class TestSymbolNormalizer:
    def test_binance_spot(self):
        from unified_api_contracts.unified_normalised_contracts.normalize.symbols import (
            normalize_symbol,
        )
