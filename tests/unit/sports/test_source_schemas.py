...
from unified_api_contracts.external.sports.sources.api_football.schemas import (
    APIFootballEvent,
    APIFootballFixture,
    APIFootballLeague,
    APIFootballLineup,
...
from unified_api_contracts.external.sports.sources.open_meteo.schemas import (
    OpenMeteoForecast,
    OpenMeteoWeather,
    WeatherAtKickoff,
    WeatherCondition,
)
from unified_api_contracts.external.sports.sources.pinnacle.schemas import (
    PinnacleEvent,
    PinnacleLine,
    PinnacleMatchup,
    PinnacleOdds,
