...
from unified_api_contracts.sports.sources.oddsjam.schemas import (
    OddsJamGame,
    OddsJamMarket,
    OddsJamOdds,
)
from unified_api_contracts.sports.sources.opticodds.schemas import (
    OpticOddsFixture,
    OpticOddsMarket,
    OpticOddsSportsbook,
)
...
class TestStreamingSourceExports:
    def test_import_opticodds(self) -> None:
        from unified_api_contracts.sports.sources.opticodds import (
            OpticOddsFixture,
            OpticOddsMarket,
            OpticOddsSportsbook,
        )
    ...
    def test_import_oddsjam(self) -> None:
        from unified_api_contracts.sports.sources.oddsjam import (
            OddsJamGame,
            OddsJamMarket,
            OddsJamOdds,
        )
