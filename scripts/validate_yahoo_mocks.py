...
class MockValidator:
    ...
    def validate_all_mocks(self) -> bool:
        ...
        for mock_file in mock_files:
            ...
            logger.info("Validating %s...", mock_file)
    ...
    def validate_dividends_mock(self, data: dict[str, object], file_path: Path) -> bool:
    ...
    def validate_splits_mock(self, data: dict[str, object], file_path: Path) -> bool:
    ...
    def validate_earnings_mock(self, data: dict[str, object], file_path: Path) -> bool:
    ...
    def validate_error_mock(self, data: dict[str, object], file_path: Path) -> bool:
