...
| **KRAKEN** | CCXT only | Via CCXT; no direct adapter |
...
| **CCXT** | BINANCE-SPOT, BINANCE-FUTURES, OKX, BYBIT, COINBASE-SPOT, UPBIT, KRAKEN, KUCOIN, GATEIO-SPOT, BITFINEX-SPOT, HUOBI-SPOT | Unified REST; order, trade, balance, position, ticker, orderbook |
