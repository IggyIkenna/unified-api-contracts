...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| **Tardis**        | BINANCE-SPOT, BINANCE-FUTURES, COINBASE-SPOT, DERIBIT, BYBIT-SPOT, BYBIT-FUTURES, OKX-SPOT, OKX-FUTURES, OKX-SWAP, GEMINI-SPOT, BITSTAMP-SPOT, HUOBI-SPOT, HUOBI-FUTURES, GATEIO-SPOT, GATEIO-FUTURES, PHEMEX-SPOT, PHEMEX-FUTURES | Historical CeFi; exchanges, instruments, trades, book              |
...
| **CCXT**          | BINANCE-SPOT, BINANCE-FUTURES, OKX, BYBIT, COINBASE-SPOT, UPBIT, KUCOIN, GATEIO-SPOT, HUOBI-SPOT                                                                                                                                   | Unified REST; order, trade, balance, position, ticker, orderbook   |
