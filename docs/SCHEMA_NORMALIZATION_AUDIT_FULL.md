...
| databento | DatabentoMbp1, Mbp10, Tbbo | CanonicalOrderBook | normalize_databento_*_orderbook | Mapped |
...
|-----------|----------------------|---------------|--------|
| unified-market-interface | CanonicalTrade, CanonicalOrderBook, CanonicalTicker, etc. | unified_api_contracts.unified_normalised_contracts | UAC |
| unified-trade-execution-interface | CanonicalOrder, CanonicalFill, CanonicalBalance, CanonicalPosition | unified_api_contracts.unified_normalised_contracts | UAC |
